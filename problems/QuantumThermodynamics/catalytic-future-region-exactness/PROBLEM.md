# QTD011 Catalysable Future Region Exactness
...
<problem id="QTD011">
  ...
  <known>
    ...
    This entry is distinct from QTD011's neighbor entry
    strict-catalytic-thermal-operation-convertibility (QTD003), which asks
  ...
  <ask>
    ...
    QTD003) that is not also shown to reproduce \(\mathcal C_+(\v p)\)
    exactly as a set.
  </ask>
