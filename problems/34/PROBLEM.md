# 34 Clustering-Mixing Equivalence for Non-Commuting Quantum Gibbs Samplers
...
<problem id="34">
  ...
  <known>
    ...
    resolve the claim above. 39
    asks only whether some Davies generator has a
    ...
    clustering are equivalent (39's own "strong clustering" is defined
