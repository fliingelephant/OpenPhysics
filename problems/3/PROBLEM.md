# 3 Werner Two-Copy Distillability
...
<problem id="3">
  ...
  <refs>
    ...
    <ref>Open Quantum Problems, Open Quantum Problems list, IQOQI Vienna, https://oqp.iqoqi.oeaw.ac.at/open-quantum-problems, used only as broad collection provenance for the surrounding OQP distillability theme; the current OQP Problem 5 listing is not the PRX Quantum Werner-state problem recorded in this entry.</ref>
